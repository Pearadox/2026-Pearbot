...
public class IntakeDrive extends Command {
  ...
  public IntakeDrive(CANFuelSubsystem fuelSystem, CANDriveSubsystem driveSystem, double xSpeed, double zRotation) {
  ...
  public void initialize() {
    fuelSubsystem
        .setIntakeRoller(SmartDashboard.getNumber("Intaking intake roller value", INTAKING_INTAKE_VOLTAGE));
